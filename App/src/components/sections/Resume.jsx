    ...
    <section id="resume" className="min-h-screen py-20 bg-gradient-to-b from-slate-900/50 to-slate-950">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-slate-300 mb-2">📧 jdavis.prsvr@gmail.com | 📱 (931) 210-8791</p>
          <p className="text-slate-300 mb-2">🌐 jldavistech.com</p>
          <p className="text-slate-300">💻 github.com/fishrifle | 💼 linkedin.com/in/jesse-davis-tech</p>
        </div>

        {/* Work Experience */}
        <div className="mb-12">
          <h3 className="text-3xl font-bold text-blue-400 mb-8">Work Experience</h3>
        ...
        {/* Technical Skills */}
        <div className="mb-12">
          <h3 className="text-3xl font-bold text-blue-400 mb-6">Technical Skills</h3>
        ...
        <div className="text-center">
          <a
            ...
            className="inline-block px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-500 text-white font-semibold rounded-lg hover:from-blue-500 hover:to-blue-400 transition-all duration-300 hover:scale-105 shadow-lg shadow-blue-500/30"
          >
